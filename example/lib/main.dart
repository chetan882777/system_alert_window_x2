...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    _initPlatformState();
    _requestPermissions();
    SystemAlertWindowX2.registerOnClickListener(callBack);
  }
  ...
  Future<void> _initPlatformState() async {
    ...
    try {
      platformVersion = await SystemAlertWindowX2.platformVersion;
  ...
  Future<void> _requestPermissions() async {
    await SystemAlertWindowX2.requestPermissions;
  }
  ...
  void _showOverlayWindow() {
    if (!_isShowingWindow) {
      ...
      SystemAlertWindowX2.showSystemWindow(
          height: 230,
          header: header,
          body: body,
          footer: footer,
      ...
      SystemWindowFooter footer = SystemWindowFooter(
          ...
          decoration: SystemWindowDecoration(startColor: Colors.white),
          buttonsPosition: ButtonPosition.CENTER);
      SystemAlertWindowX2.updateSystemWindow(
          height: 230,
          header: header,
          body: body,
          footer: footer,
      ...
      SystemAlertWindowX2.closeSystemWindow();
    }
  }
