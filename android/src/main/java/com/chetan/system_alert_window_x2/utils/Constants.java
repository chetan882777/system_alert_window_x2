...
public class Constants {
    ...
    public static final String CHANNEL = "com.chetan.system_alert_window_x2";
    public static final String BACKGROUND_CHANNEL = "com.chetan.system_alert_window_x2/background";
